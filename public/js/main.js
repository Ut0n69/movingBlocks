...
var geometry = new THREE.PlaneGeometry(block_width, block_height);
...
var min_pos_x = -(Number(width) / 2);
var max_pos_x = Number(width) / 2;
var min_pos_y = -(Number(height) / 2);
var max_pos_y = Number(height) / 2;
